...
import 'package:news_app_clean_architecture/features/daily_news/data/data_sources/local/app_datbas.g.dart';
...
import 'package:news_app_clean_architecture/features/daily_news/data/repository/article_repository_impl_fb.dart';
...
Future<void> initializeDependencies() async {
  ...
  // Repository
  sl.registerLazySingleton<ArticleRepositoryFB>(
  ...
  /// Bloc
  sl.registerFactory(() => ArticleBlocFB(sl()));
}
